...
{	
	...
	protected:
        ...
        double getHeu(GridNodePtr node1, GridNodePtr node2, GridNodePtr startNode, GridNodePtr goalNode);
	...
	public:
        ...
        HeuristicsType heuristicsType = ManhattanHeu;
        UseTieBreaker useTieBreaker = NO;
};
